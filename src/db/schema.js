import { pgTable, text, serial, timestamp, integer, primaryKey, index, pgView } from 'drizzle-orm/pg-core';
...
// Database view combining MPs with their districts and postcodes
export const mpDistrictPostcodesView = pgView('mp_district_postcodes_view', {
  mpName: text('mp_name'),
  mpParty: text('mp_party'),
  mpPhoneNumber: text('mp_phone_number'),
  districtName: text('district_name'),
  districtPostcodes: text('district_postcodes'), // JSON array as text
}).as(sql`
  SELECT 
    m.name as mp_name,
    m.party as mp_party,
